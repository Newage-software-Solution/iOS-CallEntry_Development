...
extension String {
    ...
    func firstLetterCaps() -> String {
        ...
        {
            retVal = String(format: "%@%@", self.substring(to: self.index(after: self.startIndex)).uppercased(),self.substring(from: self.index(after: self.startIndex)))
        }
        return retVal;
    }
...
//        if (self.characters.count <= 1)
//        {
//            retVal = self.capitalizedStringWith;
//        }
//        else
//        {
//            retVal = String(format: "%@%@", self.substringToIndex(self.startIndex.successor()).uppercaseString,self.substringFromIndex(self.startIndex.successor()))
//        }
//        return retVal;
//    }

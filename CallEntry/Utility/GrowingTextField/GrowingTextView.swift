...
open class GrowingTextView: UITextView {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        if text.isEmpty {
            ...
            let placeHolderRect = CGRect(x: xValue, y: yValue + 5, width: width, height: height)
            ...
            if let attributedPlaceholder = attributedPlaceHolder {
                ...
                var attributes: [NSAttributedStringKey: Any] = [
                    NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): placeHolderColor,

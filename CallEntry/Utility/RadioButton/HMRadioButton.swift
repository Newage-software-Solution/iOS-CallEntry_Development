...
@IBDesignable
public class  HMRadioButton: UIButton {
    ...
    @IBOutlet var otherButtons: Array<HMRadioButton>?
    ...
    private var setOtherButtons:NSArray {
        ...
        set (newValue) {
            if (!self.isGroupModifing()){
                ...
                let otherNewButtons:Array<HMRadioButton>? = newValue as? Array<HMRadioButton>
            ...
            self.otherButtons = newValue as? Array<HMRadioButton>
        }
    }
...
//        UIGraphicsPopContext()
        ...
        image.accessibilityIdentifier = HMRadioButton.kGeneratedIconName;
        return image;
    }
...
//        }
    ...
    func initRadioButton () {
        super.addTarget(self, action:#selector(touchDown), for:.touchUpInside)
//        self.isSelected = false
    }
    ...
    func groupModifing(chaining:Bool) {
        HMRadioButton._groupModifing = chaining
    }
    
    func isGroupModifing() -> Bool {
        return HMRadioButton._groupModifing
    }
    
    //    @return Selected button in same group.
    
    public func selectedButton() -> HMRadioButton!{
        if !self.multipleSelectionEnabled {
            if self.isSelected {
                return self
            }
        }else{
            for HMRadioButton in self.otherButtons!  {
                if HMRadioButton.isSelected {
                    return HMRadioButton
                }
            }
        }
        return nil
    ...
    public func unSelectedButtons() -> NSArray{
        ...
        for HMRadioButton in self.otherButtons!  {
            if HMRadioButton.isSelected == false {
                unSelectedButtons.add(self)
            }
        }

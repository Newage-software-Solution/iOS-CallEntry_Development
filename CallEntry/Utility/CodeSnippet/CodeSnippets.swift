...
//        let estimatedFrame = NSString(string: text).boundingRect(with: size, options: options, attributes: [NSAttributedStringKey.font: UIFont(name: AvenirFont.avenirRoman.rawValue, size: 14.0)!], context: context)
//
...
//    }
    ...
    //Get Data from Json File in App Bundle
    class func getJsonDataForFile(fileName: String) -> Data? {
